...
public class NQueensAllSolutions {
	public static void main(String[] args){
		...
		playGame(n, placed, chessBoard, badSquares, solutions);
		
		System.out.println("Total solutions: "+solutions.size());
		
	} // main
	
	public static void playGame(int n, int placed,int[][] chessBoard, int[][] badSquares, ArrayList<int[][]> solutions){
		...
		for (int col=0; col < chessBoard.length; col++) {
			if(!isPositionTaken(placed, col, badSquares)) {
				...
				playGame(n, placed+1, chessBoard, nextBadSquares, solutions);
